...
const AboutContainer = () => {
    return (
        <section className="container col-6 about__container">
            <h3>About.</h3>
            <p>
            ...
            <p>
                Outside of tech, I am a rabid fan of all things music. Not only a fan but a player. I also enjoy riding and working on vintage motorcycles in my free time. When I get to drop out of the rat-race, there is nothing I love more than a good multi-week moto-camp trip. On or off-road. I'm not picky.
            </p>
        </section>
    );
}
